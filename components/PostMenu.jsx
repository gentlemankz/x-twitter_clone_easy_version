export default function PostMenu() {
    return(
        <div className="flex gap-4 mx-4 my-4">
          <div
            className="bg-cover rounded-full bg-center w-12 h-12"
          ...
          <div className="flex flex-col w-10/12">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-md">Everyone can reply</h3>
              </div>
              <div className="my-2 border-t border-[#3e4144]" />
              <div className="flex flex-row justify-between items-center h-12">
                ...
                <button className="w-2/12 h-4/6 bg-sky-400 rounded-full">Post</button>
              </div>
              <div className="my-2 border-t border-[#3e4144]" />
            </div>
          </div>
